  ...
  return (
    <div className="border-t py-10 w-full">
      <h1
        className={
          !darkMood
            ? "md:text-2xl text-[#4f46e5] font-[SatoshiFont] text-xl text-center font-bold uppercase mb-5"
            : "md:text-2xl text-[#4f46e5] font-[SatoshiFont] text-xl text-center font-bold uppercase mb-5"
        }
      >
      ...
      <p
        className={
          !darkMood
            ? "md:text-2xl text-[#4f46e5] font-[SatoshiFont] text-xl text-center font-bold uppercase mb-10 mt-5"
            : "md:text-2xl text-[#4f46e5] font-[SatoshiFont] text-xl text-center font-bold uppercase mb-10 mt-5"
        }
      >
